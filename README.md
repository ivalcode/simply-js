...
Все имена событий можно использовать в свойстве event, но также доступно добавление любого js кода вне объекта-компонента, включая добавление обработку событий, но его все равно лучше делать через делегирование событий из документа или корневого элемента в html-коде, либо аасинхронно в setInterval с проверкой, что элемент появился в DOM, т.к. все компоненты подключаются ассинхронно
